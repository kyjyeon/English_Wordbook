...
//spelling을 반환한다.
string VocaType::GetEnglish() {
	return m_english;
}

//뜻을 반환한다.
string VocaType::GetKorean() {
	return m_korean;
}
...
double VocaType::GetWrong() {
	return m_wrong;
}

double VocaType::GetCorrectPercent() {
...
void VocaType::DisplayVoca() {
	DisplayId();
	DisplayEnglish();
	DisplayKorean();
}

void VocaType::DisplayCorrectPercent() {
