...
public:
	...
	*/
	...
	/*
	*	@brief	Destructor for deallocating dynamic allocation
	*/
	~UnsortedLinkedList();									//소멸자(객체내 동적할당 요소들을 전부 할당 해제)

	/*
	*	@brief	Insert data into the list containing parameter data info 
	*/
...
template <typename T>
bool UnsortedLinkedList<T>::IsFull() {
